/*! For license information please see bundle.5cabba721c944efb819f.js.LICENSE.txt */
(() => {
  var e,
    t,
    n = {
      74: (e, t, n) => {
        ...
        a.push([
          ...
          "",
          {
            ...
            names: [],
            mappings:
              "AAAA;EACE,gBAAA;EACA,YAAA;EACA,aAAA;AACF;AAJA;EAMI,qBAAA;AACJ",
            sourcesContent: [
              "body {\n  background: #ddd;\n  color     : green;\n  display   : flex;\n\n  div {\n    border: 1px solid red;\n  }\n}",
            ],
            sourceRoot: "",
        ...
        !(function (t, n) {
                    ...
                    for (t in e)
                      (r = e[t]),
                        "__proto__" !== t &&
                          ...
                          (l &&
                          r &&
                          (A.isPlainObject(r) || (o = Array.isArray(r)))
                            ? ((n = a[t]),
                              (i =
                                o && !Array.isArray(n)
                                  ? []
          ...
          (A.filter = function (e, t, n) {
            ...
            A.fn.extend({
              ...
              is: function (e) {
                return !!q(
                  this,
                  "string" == typeof e && N.test(e) ? A(e) : e || [],
                  !1
                ).length;
              },
            });
              ...
              function (e, t) {
                A.fn[e] = function (n, r) {
                  ...
                  return (
                    ...
                    this.length > 1 &&
                      (M[e] || A.uniqueSort(o), P.test(e) && o.reverse()),
                    this.pushStack(o)
                  );
                };
              }
                        ...
                        return function () {
                              ...
                              : function () {
                                  try {
                                    ...
                                    A.Deferred.exceptionHook &&
                                      A.Deferred.exceptionHook(r, c.stackTrace),
                                      e + 1 >= i &&
                                        (n !== W && ((s = void 0), (u = [r])),
                                        t.rejectWith(s, u));
                                  }
                          ...
                          e
                            ...
                            : (A.Deferred.getStackHook &&
                                (c.stackTrace = A.Deferred.getStackHook()),
                              r.setTimeout(c));
                        };
                      }
            ...
            A.extend({
              ...
              ready: function (e) {
                (!0 === e ? --A.readyWait : A.isReady) ||
                  ((A.isReady = !0),
                  (!0 !== e && --A.readyWait > 0) || _.resolveWith(x, [A]));
              },
            }),
            (A.ready.then = _.then),
            "complete" === x.readyState ||
            ("loading" !== x.readyState && !x.documentElement.doScroll)
              ? r.setTimeout(A.ready)
            ...
            return (
              (n =
                void 0 !== e.getElementsByTagName
                  ...
                  : []),
              void 0 === t || (t && D(e, t)) ? A.merge([e], n) : n
            );
          }
          function we(e, t) {
            for (var n = 0, r = e.length; n < r; n++)
          ...
          function Ce(e, t, n, r, o) {
            for (
              ...
              if ((i = e[d]) || 0 === i)
                if ("object" === T(i)) A.merge(p, i.nodeType ? [i] : i);
                else if (Te.test(i)) {
                  for (
          ...
          function Ne(e, t, n) {
            n
              ...
              : void 0 === K.get(e, t) && A.event.add(e, t, Ee);
          }
          (A.event = {
            global: {},
                  ...
                  if (
                    ...
                    a &&
                      ...
                      ((f.teardown && !1 !== f.teardown.call(e, h, v.handle)) ||
                        A.removeEvent(e, d, v.handle),
                      delete u[d]);
                  } else for (d in u) A.event.remove(e, d + t[l], n, r, !0);
                A.isEmptyObject(u) && K.remove(e, "handle events");
              }
            },
            dispatch: function (e) {
              var t,
              ...
              if (
                ...
                for (
                  a = A.event.handlers.call(this, u, l), t = 0;
          ...
          function Me(e, t) {
            ...
            if (1 === t.nodeType) {
              ...
              Z.hasData(e) &&
                ((i = Z.access(e)), (a = A.extend({}, i)), Z.set(t, a));
            }
          }
          function Re(e, t) {
            var n = t.nodeName.toLowerCase();
          ...
          function Ie(e, t, n, r) {
            ...
            if (
              ...
              for (s = (a = A.map(be(o, "script"), Oe)).length; f < p; f++)
                (l = o),
                  f !== d &&
                    ((l = A.clone(l, !0, !0)),
                    s && A.merge(a, be(l, "script"))),
                  n.call(e[f], l, f);
              if (s)
                for (
                  c = a[a.length - 1].ownerDocument, A.map(a, Pe), f = 0;
                  f < s;
                  f++
                )
                  (l = a[f]),
          ...
          A.extend({
            ...
            cleanData: function (e) {
              for (
                var t, n, r, o = A.event.special, i = 0;
                void 0 !== (n = e[i]);
                i++
              )
                if (J(n)) {
            ...
            A.each(
              ...
              function (e, t) {
                A.fn[e] = function (e) {
                  for (
                    var n, r = [], o = A(e), i = o.length - 1, a = 0;
                    a <= i;
                    a++
                  )
          ...
          function tt(e, t, n, r, o, i) {
            ...
            for (; a < 4; a += 2)
              "margin" === n && (u += A.css(e, n + ie[a], !0, o)),
                r
                  ? ("content" === n &&
                      (u -= A.css(e, "padding" + ie[a], !0, o)),
                    "margin" !== n &&
                      (u -= A.css(e, "border" + ie[a] + "Width", !0, o)))
                  : ((u += A.css(e, "padding" + ie[a], !0, o)),
                    "padding" !== n
                      ? (u += A.css(e, "border" + ie[a] + "Width", !0, o))
                      : (s += A.css(e, "border" + ie[a] + "Width", !0, o)));
            return (
              !r &&
                i >= 0 &&
                (u +=
              ...
              A.cssHooks[t] = {
                ...
                set: function (e, n, r) {
                  var o,
                    ...
                    s =
                      (a || r) && "border-box" === A.css(e, "boxSizing", !1, i),
                    u = r ? tt(e, t, r, s, i) : 0;
                  return (
                    s &&
                      a &&
              ...
              _default: {
                ...
                set: function (e) {
                  A.fx.step[e.prop]
                    ? A.fx.step[e.prop](e)
                    : 1 !== e.elem.nodeType ||
                      (!A.cssHooks[e.prop] && null == e.elem.style[Ge(e.prop)])
                    ? (e.elem[e.prop] = e.now)
          ...
          function pt(e, t, n) {
            ...
            for (
              ...
              if ((r = pt.prefilters[i].call(l, e, c, l.opts)))
                return (
                  m(r.stop) &&
                    (A._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)),
                  r
                );
            return (
              A.map(c, ft, l),
              ...
              A.fx.timer(
                A.extend(u, { elem: e, anim: l, queue: l.opts.queue })
              ),
              l
            );
          }
          ...
          var dt,
            ht = A.expr.attrHandle;
          A.fn.extend({
            attr: function (e, t) {
              return z(this, A.attr, e, t, arguments.length > 1);
            },
          ...
          A.fn.extend({
            prop: function (e, t) {
              return z(this, A.prop, e, t, arguments.length > 1);
            },
              ...
              return arguments.length
                ? ((r = m(e)),
                  this.each(function (n) {
                    var o;
                    1 === this.nodeType &&
                      (null == (o = r ? e.call(this, n, A(this).val()) : e)
                        ? (o = "")
                        : "number" == typeof o
                        ? (o += "")
                        : Array.isArray(o) &&
                ...
                ? (t =
                    A.valHooks[o.type] ||
                    A.valHooks[o.nodeName.toLowerCase()]) &&
                  "get" in t &&
            ...
            A.extend({
              valHooks: {
                ...
                select: {
                  ...
                  set: function (e, t) {
                    for (
                      var n, r, o = e.options, i = A.makeArray(t), a = o.length;
                      a--;

                    )
                      ((r = o[a]).selected =
                        A.inArray(A.valHooks.option.get(r), i) > -1) &&
                        (n = !0);
            ...
            A.extend({
              ...
              ajax: function (e, t) {
                ...
                var n,
                  ...
                  d = A.ajaxSetup({}, t),
                  h = d.context || d,
                  g = d.context && (h.nodeType || h.jquery) ? A(h) : A.event,
                  v = A.Deferred(),
                ...
                d.ifModified &&
                  (A.lastModified[o] &&
                    C.setRequestHeader("If-Modified-Since", A.lastModified[o]),
                  A.etag[o] && C.setRequestHeader("If-None-Match", A.etag[o])),
                    ...
                    f
                      ? (d.ifModified &&
                          ((w = C.getResponseHeader("Last-Modified")) &&
                            (A.lastModified[o] = w),
                          (w = C.getResponseHeader("etag")) && (A.etag[o] = w)),
                        204 === e || "HEAD" === d.type
                          ? (T = "nocontent")
                          : 304 === e
                          ? (T = "notmodified")
          ...
          A.ajaxSetup({
            ...
            A.ajaxPrefilter("json jsonp", function (e, t, n) {
              ...
              if (s || "jsonp" === e.dataTypes[0])
                return (
                  ...
                  n.always(function () {
                    void 0 === i ? A(r).removeProp(o) : (r[o] = i),
            ...
            A.each(["top", "left"], function (e, t) {
              A.cssHooks[t] = ze(v.pixelPosition, function (e, n) {
                if (n)
                  return (
                    (n = Ue(e, t)), We.test(n) ? A(e).position()[t] + "px" : n
                  );
              });
            }),
          ...
          return (
            (A.noConflict = function (e) {
              return (
                r.$ === A && (r.$ = Qt),
                e && r.jQuery === A && (r.jQuery = Jt),
                A
              );
            }),
            void 0 === o && (r.jQuery = r.$ = A),
            A
          );
        });
      },
  ...
  (o.m = n),
    ...
    (o.u = (e) => "bundle.60ff54368d8cdc84fc82.js"),
    (o.g = (function () {
    ...
    (() => {
      ...
      var t = (t, n) => {
          for (var r, i, [a, s, u] = n, l = 0, c = []; l < a.length; l++)
            (i = a[l]), o.o(e, i) && e[i] && c.push(e[i][0]), (e[i] = 0);
          for (r in s) o.o(s, r) && (o.m[r] = s[r]);
          for (u && u(o), t && t(n); c.length; ) c.shift()();
        },
        n = (self.webpackChunkwebpack_demo_1 =
          self.webpackChunkwebpack_demo_1 || []);
    ...
    (() => {
      ...
      i()(a.Z, { insert: "head", singleton: !1 }),
        ...
        n()(document.body).append(
          ((e = n()("<div />")).html(["Hello", "World!", "frank"], " "), e)
        ),
        o
          .e(905)
          .then(o.bind(o, 905))
          .then((e) => {
            console.log("logo", e.default);
            var t = n()(
              `<img src=${e.default} style="transform: translate(-40%, -40%) scale(.2)" />`
            );
            n()(document.body).append(t);
          });
    })();
})();
//# sourceMappingURL=bundle.5cabba721c944efb819f.js.map
